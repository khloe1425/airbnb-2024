...
const UserPage: React.FC = () => {
  ...
  //   if (searchValue !== "") {
  //     router.push(
  //       `/${locale}/admin/users/?page=1&size=10&keyword=${searchValue.replace(
  //         /\s+/g,
  //         ""
  //       )}`
  //     );
  //   } else {
  //     router.push(`/${locale}/admin/users/?page=1&size=10`);
  //   }
  // };
  ...
  const handleSearchUsers = async (searchValue: string): Promise<void> => {
    if (searchValue !== "") {
      router.push(
        `/${locale}/admin/users/?page=1&size=10&keyword=${encodeURIComponent(searchValue)}`
      );
    } else {
      router.push(`/${locale}/admin/users/?page=1&size=10`);
    }
              ...
              footer={() => (
                <Pagination
                  ...
                  onChange={(page: number, pageSize: number): void => {
                    ...
                    router.push(
                      `/${locale}/admin/users/?page=${page}&size=${pageSize}&keyword=${keyword}`
                    );
                  }}
                />
              )}
