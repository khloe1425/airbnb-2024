              ...
              items={[
                {
                  ...
                  label: (
                    <Link href={`/${locale}/admin`}>Biểu đồ thống kê</Link>
                  ),
                },
                {
                  key: "users",
                  ...
                  label: (
                    <Link href={`/${locale}/admin/users`}>Quản lý người dùng</Link>
                  ),
                },
                {
                  key: "locations",
                ...
                {
                  key: "hosts",
                  icon: <FontAwesomeIcon size="lg" icon={faHotel} />,
                  label: (
                    <Link href={`/${locale}/admin/hosts`}>
                      Quản lý chủ phòng
                    </Link>
                  ),
                },
